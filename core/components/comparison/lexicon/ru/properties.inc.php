...
$_lang['comparison_prop_cat'] = 'Произвольное имя списка сравнения. Если у вас товары разных типов - указывайте для них разные имена списков. Указанное имя обязательно должно быть в массиве "&fields" сниппета "CompareList".';
...
$_lang['comparison_prop_fields'] = 'JSON строка с именами списков сравнения и массивом сравниваемы полей. Например: {"test":["price","weight"]}.';
